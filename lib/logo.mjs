...
export const logoEmail = ({ display, mono, ink, ink3, size = 26, subSize = 11 }) =>
  ...
  + `<div style="font-family:${mono};font-size:${subSize}px;line-height:1.45;`
  + `letter-spacing:0.16em;text-transform:uppercase;color:${ink3};padding-top:7px;">${LOGO.sub}</div>`;
