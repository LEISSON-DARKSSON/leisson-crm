import {serviceById,serviceSnapshot,CATALOG_VERSION,SELLER} from '../../packages/service-catalog/index.mjs';
...
export function revenueSummary(db, {now=new Date(),maxAgeDays=21,ownAddresses=[]}={}) {
  ...
  return {
    ...
    qualified:db.prepare("SELECT COUNT(*) n FROM companies WHERE sales_state='qualified'").get().n,
