#!/usr/bin/env node
// css-ab värava enda värav: tööriist peab kukkuma just siis, kui CSS muudab midagi, mida plaan ei luba.
...
for (const [nimi, args, oodatud] of juhtumid) {
  const r = spawnSync(process.execPath, [join(JUUR, 'tools/css-ab.mjs'), ...args], { cwd: JUUR, encoding: 'utf8' });
